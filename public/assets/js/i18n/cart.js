/**
 * takeKONTROL — cart translations
 * Lifted verbatim from the inline <script> that used to live in
 * cart.html. Keys are shared with the markup through
...
export const dictionary = {
    de: {
        ...
        cart_title: "Ihr Warenkorb", cart_back: "← Zurück zum Shop",
        cart_empty: "Ihr Warenkorb ist derzeit leer.",
        cart_summary: "Bestellübersicht", cart_subtotal: "Zwischensumme", 
        cart_shipping: "Versand", 
        cart_total: "Gesamtsumme", btn_checkout: "Zur Kasse →", btn_remove: "Entfernen",
        btn_organizations: "Für Organisationen",
    ...
    en: {
        ...
        cart_title: "Your Cart", cart_back: "← Back to Shop",
        cart_empty: "Your cart is currently empty.",
        cart_summary: "Order Summary", cart_subtotal: "Subtotal", 
        cart_shipping: "Shipping", 
        cart_total: "Total", btn_checkout: "Proceed to Checkout →", btn_remove: "Remove",
        btn_organizations: "For Organizations",
